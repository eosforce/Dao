...
##### 2、项目描述：
（描述这个产品的开发目的、需求、以及基本功能介绍，50——200字左右。能将明白产品是什么，干什么，有什么用。）
...
##### 2、Description：
（Describe the development purpose, needs, and basic functions of this product, about 50-200 words. Can understand what the product is, what it is, what is the use.）
...
##### Project Name: Decentralized Budget System Development Expense Application
